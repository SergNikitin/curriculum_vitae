...
\begin{tabular}{p{25mm}|p{110mm}}
    ...
    по настоящее время  & Младший C/C++ разработчик                                 \\
                        &
    \begin{itemize}
        \item   Развивал системы автоматического управления семейства потребительских
        ...
        \item   Развивал ПО для корпоративной системы контроля и управления доступом
    \end{itemize}                                                                   \\
    ...
    Апрель 2013 & Техник                                                            \\
                &
    \begin{itemize}
        \item   Комплексная диагностика потребительских роботов
        \item   Производство потребительских роботов
    \end{itemize}                                                                   \\
...
\begin{itemize}
    ...
    \item   Изучение путей общего улучшения собственного (а иногда даже чужого)
...
\begin{itemize}
    ...
    \item   Музыкальные концерты различных направлений
